...
<?php
  ...
  if(isset($_POST["submit"]))
  {
      ...
      $address = $_POST["add"];
          ...
          $connectiodb;
          // Write the query for update the data of employe using there id
          $sql = "UPDATE emp_record SET ename='$ename', ssn='$ssn', dept='$dept', salary='$salary', address='$address' WHERE id='$search'";
          ...
          if($stmt)
          {
            ...
            echo '<script>window.open("view.php?id=Update succsesfuly","_self")</script>';
          } 
...
<body>
  ...
  <div class="container">
    <h2>PHP Form</h2>
    <form action="update.php?id=<?php echo $search ?>" name="form1" method="post" enctype="multipart/form-data">
      ...
      <br><button type="submit" name="submit">Update Record</button>
